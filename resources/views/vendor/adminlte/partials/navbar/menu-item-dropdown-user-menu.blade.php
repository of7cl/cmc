...
<li class="nav-item dropdown user-menu">
    ...
    <ul class="dropdown-menu dropdown-menu-sm dropdown-menu-right" style="width: 180px">
        ...
        @if (!View::hasSection('usermenu_header') && config('adminlte.usermenu_header'))
            ...
            <li class="user-header {{ config('adminlte.usermenu_header_class', 'bg-primary') }} h-auto" style="margin-bottom: -10%">                
                <p class="mt-0 mb-0"
                    style="cursor: pointer;"                    
                    onclick="window.location='{{ route('admin.users.edit', Auth::user()->id) }}'"
            ...
            <li class="user-header {{ config('adminlte.usermenu_header_class', 'bg-primary') }} h-auto style="margin-bottom: -10%">                
                <p class="mt-0 mb-0"
                    style="cursor: pointer;"                    
                    onclick="window.location='{{ route('admin.users.change_password', Auth::user()->id) }}'"
                    title="Ver control de trayectoria">
                    Cambiar Contraseña                   
                </p>
            </li>
