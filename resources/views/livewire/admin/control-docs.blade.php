        ...
        <div class="card-body table-responsive text-nowrap" style="max-height: 680px; padding:0%;">
            <table class="table-xsm table-striped table-hover" style="border-collapse: separate;">
                <thead class="table-secondary border border-secondary" style="position: sticky; top:0;">
                    <tr>
                        <th rowspan="1" colspan="2" class="border border-secondary align-middle text-center">Nave
                        </th>
                ...
                <tr> --}}
                        @foreach ($documentos as $documento)
                            <th class="border border-secondary align-middle text-center">{{ $documento->nr_documento }}
                            </th>
                        @endforeach
                    </tr>
                </thead>
                    ...
                    @foreach ($personas as $persona)
                        <tr>
                            <td class="border border-secondary" style="cursor: pointer">
                                ...
                                <button wire:click="edit({{ $persona->id }})" type="button" class="btn btn-sm btn-light"
                                    data-toggle="modal" data-target="#modalCreatePersona"><i
                            ...
                            @foreach ($documentos as $documento)
                                ...
                                @if ($persona->documento->count())
                                    ...
                                    @if ($cn > 0)
                                        ...
                                        ?>
                                        @if ($diff <= $flag_red)
                                            <td class="border border-secondary align-middle text-center table-danger">
                                                {{ $fc_fin }}</td>
                                        @elseif($diff > $flag_red && $diff < $flag_yellow)
                                            <td class="border border-secondary align-middle text-center table-warning">
                                                {{ $fc_fin }}</td>
                                        @else
                                            <td class="border border-secondary align-middle text-center table-success">
                                                {{ $fc_fin }}</td>
                                        @endif
                                    @else
                            ...
                            <div class="modal-body">
                                <div style="height:600px;">
                                    <form>
                                        ...
                                        <div class="form-group">
                                            ...
                                            @if ($ship_id == null)
                                                <select wire:model="ship_id" class="form-control"
                                                    ...
                                                    @foreach ($ships as $ship)
                                                        <option value="{{ $ship->id }}">{{ $ship->nombre }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            @else
                                        ...
                                        <div class="form-group">
                                            <label for="fc_nacimiento" class="form-label">Fecha de Nacimiento</label>
                                        ...
                                        <div class="form-group">
                                            <label for="fc_ingreso" class="form-label">Fecha de Ingreso</label>
